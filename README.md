...
当前版本：`v0.2.10` · 产品名：**游戏罪恶减轻器**

## 运行

打开 `publish/GameLearn-v0.2.10/GameLearn.exe`。交付目录包含 .NET 运行时、OCR 模型和 770,611 条 ECDICT 词典数据，无需 Python、系统英文 OCR 语言包或 API 密钥即可使用本地功能。请保留整个目录，不要单独移动 EXE。
